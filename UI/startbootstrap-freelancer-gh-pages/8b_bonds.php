...
<body id="page-top">
    ...
    <!-- <li class="nav-item">
      ...
      <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="1b_login.php">Login</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Bonds Simulation</h1>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">10 Years</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">5.8%</div>
                        </div>
                        <div class="col">
            ...
            <!-- <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Suggested articles</div>
          ...
          <!-- Page Heading -->
          <!-- <h1 class="h3 mb-2 text-gray-800">Bonds Simulation</h1> -->
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">GSA1 Bond</h6>
                </div>
                <div class="card-body">
                  <div class="chart-bar">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  The graph shows the projected growth of an investment of USD 9,000 into GSA1 bond fund over a 10-year period. 
                    <!-- <canvas id="myPieChart"></canvas> -->
                    <br><br><br><br><br><br><br><code>Disclaimer: The graph is a projection of the growth in investment. Actual performance is subject to market and  risks.</code>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="1b_login.php">Logout</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="js/demo/chart-bars-demo.js"></script>
