            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">Log In</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <form method="POST" novalidate="novalidate" action="processLogin.php">
                            ...
                            <br />
                            <div id="success"></div>
                            <div class="form-group"><input class="btn btn-primary btn-xl" type="submit" name="submit" value="Log In!" /></div>
                        </form>
                    </div>
                </div>
            </div>
